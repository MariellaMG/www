...
<div class="footleft1">
  ...
  <div class="footerholder"> 
  <ul>
           <li><a href="<?php echo $globalpath;?>preguntas-frecuentes/" title="Preguntas Frecuentes"  >Condesa Sabe</a></li>
             <li><a href="<?php echo $globalpath;?>registrate/" title="Registrate"  >Regístrate</a></li>
             <li><a href="<?php echo $globalpath;?>contacto/" title="Contactanos"  >Cont&aacute;ctanos</a></li>
             <li><a href="<?php echo $globalpath;?>acerca-de/" title="Acerca de"  >Acerca de</a></li>
             <li><a href="<?php echo $globalpath;?>directorio/restaurante" title="Restaurantes"  >Restaurantes</a></li>
             
          <li><a href="http://sebastianaguilar.me/" target="_blank" >SebastianAguilar.me</a></li> &nbsp;

     <li><a href="http://www.amorplacerysexo.com" title="AmorPlacerySexo.com" target="_blank"  >AmorPlacerySexo.com</a></li>
             
         
     <li><a href="http://sangrepolitica.com/" title="SangrePolitica.com" target="_blank"  >SangrePolitica.com</a></li>    
...
<div class="topblack" style="width:1024px; padding-left:30px; margin:auto;">
	<div class="center"><div class="smallogo"></div>
		<div class="copyleft">
			&copy; Solo Condesa. Insurgentes Sur 533<br />
		  Teléfono 47 53 80 73<br />
			Comunidad Virtual
		</div>
        ...
        <a href="http://www.deantro.com" target="_blank">
        <img src="<?php echo $globalpath;?>alianzas/deantro.jpg" width="165" height="36" alt="DeAntro" style="margin-top:10px;" />
        </a>
        </div>
        <div style="float:left">
