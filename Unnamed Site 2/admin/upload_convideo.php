<?php
  ...
  function sec2hms($sec, $padHours = false) 
  {
	...
	//$exec_string = 'ffmpeg -i '.$input.' -s qcif -vcodec h263 -acodec aac -ac 1 -ar 8000 -r 25 -ab 32 -y ../uploaded/'.$timestamp.'_.3gp';
	//shell_exec($exec_string);
	
	$exec_string = 'ffmpeg -i '.$input.' -s 720x480 -b 2500k -ab 380k -y ../uploaded/'.$timestamp.'_hd.mp4';
	shell_exec($exec_string);
