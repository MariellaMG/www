...
$qt = "SELECT * FROM informacion WHERE id_informacion='".$_GET['id']."' ";
	...
	while ($rowt = mysql_fetch_row($resultt)){
		...
		$nombre = $rowt[2];
		$streetAdress = $rowt[3];
		$addressLocality = $rowt[4];
		$addressRegion = $rowt[5];
		$postalCode = $rowt[6];
...
<h1><img src="img/icons/posts.png" alt="" />Editar información '<?php echo $nombre; ?>' </h1>
...
<form id="form1" method="post" enctype="multipart/form-data" action="paquete_agregar_form.php">
    ...
    <div class="content">
        ...
        <div class="input medium">
          ...
          <div class="input medium">
            ...
            <label for="input2">streetAdress</label>
            <input type="text" id="streetAdress" name="streetAdress" value="<?php echo $streetAdress; ?>" />
            <span>Calle y número</span>
        </div>
        
         <div class="input medium">

            <label for="input2">addressLocality</label>
            <input type="text" id="addressLocality" name="addressLocality" value="<?php echo $addressLocality; ?>" />
            <span>Colonia o municipio</span>
        </div>
        ...
        <div class="input medium">
            ...
            <label for="input2">addressRegion</label>
            <input type="text" id="addressRegion" name="addressRegion" value="<?php echo $addressRegion; ?>" />
            <span>Region del negocio</span>
        </div>
        
        
        <div class="input medium">

            <label for="input2">postalCode</label>
            <input type="text" id="postalCode" name="postalCode" value="<?php echo $postalCode; ?>" />
            <span>Código postal del negocio</span>
        </div>
        ...
        <div class="input medium">
            <label for="input2">Horarios</label>
           <?php 
		   
		   $horarios = str_replace("<br/>", "\n", $horarios);
		   $horarios = str_replace("<br>", "\n", $horarios);
		   $horarios = str_replace("<br >", "\n", $horarios);
		   $horarios = str_replace("< br>", "\n", $horarios);
		   $horarios = str_replace(" <br >", "\n", $horarios);
		   ...
		   $horarios = preg_replace('/[ ]{2,}|[\t]/', ' ', trim($horarios));
		   
		   $horarios=strip_tags($horarios);
		   
		   $horarios = trim($horarios);
		   
		   ?>
            <textarea name="horarios" id="horarios" cols="10" rows="10"><?php echo $horarios; ?></textarea>
            <span>Horarios de atención del negocio</span>
        </div> 
         <div class="input medium">
            <label for="input2">Categorias</label>
            <textarea name="categorias" id="categorias" cols="10" rows="10"><?php echo $categorias; ?></textarea>
            <span>Horarios de atención del negocio</span>
        </div> 
        
        <div class="input medium">
            <label for="input2">Descripción</label>
            <textarea name="description" id="description" cols="10" rows="10"><?php echo $description; ?></textarea>
        </div>
      	
        <div class="input medium">
            <label for="input2">Video</label>
      ...
      <input name="latitud" id="latitud" type="hidden" value="<?php echo $latitude; ?>" >
<input name="longitud" id="longitud" type="hidden" value="<?php echo $longitude; ?>">
