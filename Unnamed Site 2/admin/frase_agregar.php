...
<h1><img src="img/icons/posts.png" alt="" />Agregar Frase</h1>
...
<div class="bloc">
<form id="form1" method="post" enctype="multipart/form-data" action="frase_agregar_form.php">
...
<input name="silueta_img" id="silueta_img" type="hidden" value="">
    ...
    <div class="content">
        ...
        <div class="input medium">
            ...
            <label for="input2">Frase</label>
            <textarea name="frase" cols="" rows="" style="height:120px;"></textarea>
         ...
         <div class="input medium">
            ...
            <label for="input2">Subtexto</label>
            <textarea name="subtexto" cols="" rows="" style="height:120px;"></textarea>
            <p>Voto, Fiesta, Shock, Indignación</p>
        </div>
