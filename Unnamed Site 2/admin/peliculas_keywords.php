...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Peliculas sin keywords (<?php
	$qt = "SELECT count( * ) FROM `contenido` WHERE keywords=''";
...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM contenido WHERE keywords='' ORDER BY id_contenido DESC LIMIT 100 ";
