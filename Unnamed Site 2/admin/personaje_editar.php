...
<?php
    ...
    $qt = "SELECT * FROM personaje WHERE id_personaje =  '$id' ";
...
<h1><img src="img/icons/posts.png" alt="" />Editar personaje '<?php echo $nombre; ?>'</h1>
...
<form id="form1" method="post" enctype="multipart/form-data" action="personaje_editar_form.php">

<input id="id" name="id" type="hidden" value="<?php echo $id_personaje; ?>"  />
...
<input name="fotos" id="fotos" type="hidden" value="<?php echo $fotos; ?>">
	...
	?>
         ...
         <div class="input medium">
            <label for="input2">Fecha de Nacimiento (AÑO-MES-DIA  1982-02-25)</label>
            <input type="text" id="fecha_nacimiento" name="fecha_nacimiento" value="<?php echo $fecha_nacimiento; ?>"  />
        </div>
    
        

         <div class="input medium">
            <label for="input2">Biografia</label>
            <textarea name="bio" id="bio" rows="4" cols="2" style="width:600px; height:200px;"><?php echo $bio; ?></textarea>
        </div>
