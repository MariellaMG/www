...
function MarcarTodos(){
	...
	$('#negocios option').prop('selected', true);
	$('#negocios option').attr('selected', 'selected');
...
var frames_d="";
var archivos_d = "";
var server = "http://solomorelia.com/archivos/";
...
<h1><img src="img/icons/posts.png" alt="" />Agregar Producto</h1>
...
<div class="bloc">
<form id="form1" method="post" enctype="multipart/form-data" action="producto_agregar_form.php">
    ...
    <div class="content">
      <div class="input medium">
         ...
         <div class="input">
            <label for="select">Negocios</label>
            
            <div style=" background:#EDEDED;">
            <div style="width:205px; height:200px; float:left;">
            
            <select name="negocios[]" id="negocios" multiple size="10" style=" width:200px;"  >
            
			<?php
            
               $loskeywords = explode(",",$keywords);
                foreach ($loskeywords as &$valor) {
                    $qt = "SELECT * FROM negocio WHERE id_negocio = '$valor' LIMIT 1";
            ...
            <input name="Limpiar" type="button" value="Limpiar" style="width:200px; background:#0CF;" onClick="LimpiarID('negocios');">
            ...
            <input type="text" id="keyword" name="keyword" style="width:210px" onKeyUp="Predictivo('keyword','negocios','losnegocios');" autocomplete="off" >
            </div>
            <div style="width:39px; float:left;">
            <input name="+" type="button" value="+" onClick="AgregarElem('keyword','keyword','negocios','negocios');" style="width:39px; background:#0CF;">
            </div>
            <div style="clear:both"></div>
            </div>
            
            <select name="losnegocios[]" id="losnegocios" multiple size="10" style=" width:250px;"  >
            </select>
		...
		<div class="input medium">
            ...
            <label for="input2">HTML (Inserciones: Youtube, Xvideo, Atach files)</label>
