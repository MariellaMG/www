...
$q = "SELECT permalink FROM uni WHERE permalink LIKE '%".$permalink."%'";
...
VALUES (
NULL , '$nombre', '$tipo', '$direccion', '$id_ciudad', '$telefono', '$email', '$plandeestudios', '$convocatoria', '$tramites', '$inscripcion', '$inicio', '$costo_inscripcion', '$colegiatura' ,'$permalink','$fundacion'
);
...
<h1><img src="img/icons/posts.png" alt="" />Agregar Universidad</h1>
	...
	<div class="notif success" id="completo" style="margin-top:20px;">
            <strong>Success: </strong>La ciudad se ha agregado correctamente
