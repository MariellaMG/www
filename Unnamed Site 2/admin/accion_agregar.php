...
<h1><img src="img/icons/posts.png" alt="" />Agregar Acción</h1>
...
<form id="form1" method="post" enctype="multipart/form-data" action="accion_agregar_form.php">
...
<input name="imagen" id="imagen" type="hidden" value="">
    ...
    <div class="content">
         ...
         <div class="input medium">
            ...
            <label for="input2">ID Tweet (ejemplo: 1011327979673276416)</label>
            <input type="text" id="idtt" name="idtt" />
        </div>
         ...
         <div class="input medium">
            ...
            <label for="input2">Tweets que contengan</label>
            <input type="text" id="tweets" name="tweets" />
        </div>
        
          <div class="input textarea">
            <label for="textarea1">Descripcion:</label>
            <textarea name="descripcion" id="descripcion" rows="4" cols="2" style="width:470px;"></textarea>
            <br>
            Incluye el twit y la liga
        </div>
