...
$colaborador = VaciarComillas($colaborador);
$nombre = VaciarComillas($nombre);


/*

UPDATE `colaborador` SET `nombre` = 'Cesar Sebastian Aguilar Aguilera.',
`foto` = '.' WHERE `colaborador`.`id_colaborador` =1 LIMIT 1 ;


*/


$qin = " UPDATE `colaborador` SET 
...
<h1><img src="img/icons/posts.png" alt="" />Usuario editado '<?php echo $nombre; ?>'</h1>

	<div class="notif success" id="completo" style="margin-top:20px;">
            <strong>Success: </strong>El usuario se ha guardado correctamente
