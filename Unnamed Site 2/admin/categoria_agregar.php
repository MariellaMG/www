...
<h1><img src="img/icons/posts.png" alt="" />Agregar categoria</h1>
...
<form id="form1" method="post" enctype="multipart/form-data" action="categoria_agregar_form.php">
    ...
    <div class="content">
      <div class="input medium">
         ...
         <div class="input medium">
            ...
            <label for="input2">Orden (0-20)</label>
        ...
        <div class="input medium" >
          ...
          <label for="input2">Foto de la categoria</label>
