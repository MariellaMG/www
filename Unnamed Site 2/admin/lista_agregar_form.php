...
$q = "SELECT permalink FROM lista WHERE permalink LIKE '".$permalink."%'";
...
$laspeliculas = implode(",", $peliculas);



$qin = "
INSERT INTO `pelicula_db`.`lista` (`id_lista`, `nombre`, `permalink`, `descripcion`, `imagen`, `fotos`, `peliculas`, `id_editor`, `orden`, `extra`) VALUES (NULL, '$nombre', '$permalink', '$descripcion', '$imagen', '$fotos', '$laspeliculas', '$id_editor', '$orden', '1');
";
