...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Generos 
</h1>
...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM keyword ORDER BY total DESC LIMIT 500 ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * FROM keyword WHERE keyword LIKE '%$pal%' or orden LIKE '%$pal%' or permalink LIKE '%$pal%' ORDER BY total DESC LIMIT 500";
	}
	...
	?>
                  ...
                  <tr id="linea<?php echo $id; ?>">
                    ...
                    <td><?php echo utf8_encode($keyword); ?></td>
                     <td><a href="/tematica/<?php echo $permalink; ?>" target="_blank"><?php echo $permalink; ?></a></td>
