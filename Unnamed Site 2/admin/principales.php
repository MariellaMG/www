...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Entradas PRINCIPALES
</h1>
    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
	$qt = "SELECT * FROM entrada WHERE principal='1' AND estatus='1' ORDER BY prioridad LIMIT 50 ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * FROM entrada WHERE principal = '1' AND estatus='1' AND ( titulo LIKE '%$pal%' or descripcion LIKE '%$pal%' or intro LIKE '%$pal%'  or permalink LIKE '%$pal%') LIMIT 50";
	}
