...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Entradas más VISITADAS
</h1>
    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
	$qt = "SELECT * FROM entrada ORDER BY visitas DESC LIMIT 50 ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * FROM entrada WHERE visitas > '0' AND ( titulo LIKE '%$pal%' or descripcion LIKE '%$pal%' or intro LIKE '%$pal%'  or permalink LIKE '%$pal%') LIMIT 50";
	}
