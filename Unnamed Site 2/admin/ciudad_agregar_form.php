...
$q = "SELECT permalink FROM ciudad WHERE permalink LIKE '".$permalink."-%'";
...
VALUES (
NULL , '$nombre', '$latitud', '$longitud','$zoom','$extra','$permalink','$posicion_earth');";
...
<h1><img src="img/icons/posts.png" alt="" />Agregar ciudad</h1>
