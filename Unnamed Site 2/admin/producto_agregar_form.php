...
$qin = "
INSERT INTO `producto` (`id_producto`, `nombre`, `descripcion`, `permalink`, `html`, `imagen`, `fotos`, `archivos`, `id_editor`,`negocios`)
 VALUES 
 (NULL, '$nombre', '$descripcion', '$permalink', '$html', '$imagen', '$fotos', '$archivos', '$id_editor','$losnegocios');
";
