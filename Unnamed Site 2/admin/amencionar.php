...
function Eliminar(t_id){
	if(confirm("Estas seguro que deseas borrar esta cuenta a mencionar?")){
		$.get("amencionar_eliminar_get.php?id="+t_id, function(data){
...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Cuentas a mencionar
</h1>
...
<div class="bloc">
    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
	$qt = "SELECT * FROM amencionar order by conteo DESC ";
	...
	if($pal!=""){
		$qt = "SELECT * FROM amencionar WHERE cuenta LIKE '%$pal%' ORDER BY categoria";
	}
	...
	?>
                  ...
                  <tr id="linea<?php echo $rowt[0]; ?>" >
                    ...
                    <td><a href="http://twitter.com/<?php echo utf8_encode($cuenta); ?>" target="_blank" > @<?php echo utf8_encode($cuenta); ?>   </a></td>
                    
                    <td><?php echo ($mencionado); ?></td>
