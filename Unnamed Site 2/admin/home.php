...
<div class="bloc left">
    ...
    <div class="content dashboard">
        ...
        <div class="center">
             ...
             <a href="paquetes.php" class="shortcut">
                <img src="img/contact.png" alt="" width="48" height="48" />
                Paquetes 
            </a>
            
             <a href="entradas.php" class="shortcut">
...
<div class="bloc right">
        ...
        <div >
            ...
            <table class="noalt">
                ...
                <tbody>
                  ...
                  <tr>
                        <td width="16%"><h4><?php
	$qt = "SELECT count( * ) FROM `mega_liga` ";
	$resultt = mysql_query($qt, $db);
	while ($rowt = mysql_fetch_row($resultt)){
		echo $rowt[0];
	}
	?></h4></td>
                        <td width="84%">Ligas base Mega Travel</td>
                    </tr>
	...
	?></h4></td>
                        <td width="84%">Paquetes Mega Travel</td>
                    </tr>
                
                
                    <tr>
                        <td width="16%"><h4><?php
	$qt = "SELECT count( * ) FROM `entrada` ";
	$resultt = mysql_query($qt, $db);
	while ($rowt = mysql_fetch_row($resultt)){
		echo $rowt[0];
	}
	?></h4></td>
                    ...
                    <tr>
                        <td><h4><?php
	$qt = "SELECT count( * ) FROM `informacion` ";
	$resultt = mysql_query($qt, $db);
	while ($rowt = mysql_fetch_row($resultt)){
		echo number_format($rowt[0]);
	}
	?></h4></td>
                        <td>Contenidos de información</td>
                    </tr>
