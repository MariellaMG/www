...
*/
	...
	while ($row = mysqli_fetch_row($resu)){
		...
		$qt = "SELECT * FROM `porcrear` LIMIT $cc,240 ";
		$cc+=240;
		//echo $qt;
		...
		while ($rowt = mysqli_fetch_row($resul)){
			...
			$qt = "UPDATE `porcrear` SET `id_responsable` = '$id_capturista' WHERE `porcrear`.`id_porcrear` = '$id_revisar';";
			echo $qt."<br />
			";
