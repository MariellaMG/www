...
*/
	...
	$qt = "SELECT * FROM busqueda_express WHERE extra='1' ";
	echo $qt;
...
";
				...
				$qt="INSERT INTO `express_dato_dos` (`id_express_dato`, `id_busqueda_express`, `dato`, `extra`) VALUES (NULL, '$id_busqueda_express', '$value', '');";
				$resultt = mysqli_query($link,$qt);
			 }
		 }
		 if($key=="next_results"){
