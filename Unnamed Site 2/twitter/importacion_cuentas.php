...
*/
	...
	$qt = "SELECT `COL 6`,`COL 7`,`COL 2` FROM `TABLE 18` WHERE `COL 10`  LIKE '%NO%' AND `COL 10`  LIKE '%n%' AND `COL 2` NOT LIKE '%Usuario%'  ";
	echo $qt."<br />
";
	...
	while ($rowt = mysqli_fetch_row($resultt)){
		...
		$qt = "SELECT cuenta FROM cuentas WHERE cuenta = '$cuenta' ";
		echo $qt."<br />
";
		...
		if($c<=0){
			...
			$qt = "INSERT INTO `cuentas` (`id_cuenta`, `cuenta`, `pass`, `nombre`) VALUES (NULL, '$cuenta', '$pass', '$nombre');";
			echo $qt."<br />
";
			//$resul = mysqli_query($link,$qt);
		}else{
