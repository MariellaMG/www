...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  $qt = "SELECT * FROM porcrear WHERE id_responsable='$id_capturista' ";
	//echo $qt;
	$resul = mysqli_query($link,$qt);
	while ($rowt = mysqli_fetch_row($resul)){
		$id_revisar = $rowt[0];
  ...
  ?>
   ...
   <tr style="height:40px;">
    ...
    <td><input type="text" style="width:80%;" value="<?php echo $email ?>" /></td>
    <td><input type="text" style="width:80%;" value="<?php echo $nacimiento ?>" /></td>
    <td><input type="text" style="width:80%;" value="<?php echo $twitter ?>" /></td>
    <td><input type="text" style="width:80%;" value="<?php echo $pass; ?>" /></td>
    <td><input type="text" style="width:80%;" value="<?php echo $facebook; ?>" /></td>
    <td><input type="text" style="width:80%;" value="<?php echo $pass_fb; ?>" /></td>
  </tr>
