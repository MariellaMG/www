...
function MarcarTodos(){
	...
	$('#peliculas option').prop('selected', true);
	$('#peliculas option').attr('selected', 'selected');
...
<h1><img src="img/icons/posts.png" alt="" />Agregar lista de peliculas</h1>
...
<form id="form1" method="post" enctype="multipart/form-data" action="lista_agregar_form.php">
...
<input name="fotos" id="fotos" type="hidden" value="">
    ...
    <div class="input medium">
        <label for="input2">Titulo</label>
            <input type="text" id="nombre" name="nombre" style="width:590px;" />
        </div>
         ...
         <div class="input medium">
            ...
            <input type="text" id="orden" name="orden" style="width:110px;" />
        </div>
        
        
         <div class="input medium">
            <label for="input2">Descripción</label>
            <textarea name="descripcion" id="descripcion" rows="4" cols="2" style="width:590px; height:250px;"></textarea>
        </div>
      ...
      <div class="input">
            <label for="select">Propiedades</label>
            
            <div style=" background:#EDEDED;">
            <div style="width:305px; height:360px; float:left;">
            
            <select name="peliculas[]" id="peliculas" multiple size="10" style=" width:300px; height:300px;"  >
            
			
            </select>
            
            <input name="Limpiar" type="button" value="Limpiar" style="width:200px; background:#0CF;" onClick="LimpiarID('peliculas');">
            ...
            <input type="text" id="pelicula" name="pelicula" style="width:292px;" onKeyUp="Predictivo('pelicula','peliculas','listado');" >
            </div>
            
            <div style="clear:both"></div>
            </div>
            
            <select name="listado[]" id="listado" multiple size="10" style=" width:290px; height:265px;"  >
            </select>
