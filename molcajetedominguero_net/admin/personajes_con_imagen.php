...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Personajes con imagen (<?php
...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM personaje WHERE imagen!='' ORDER BY id_personaje DESC LIMIT 50 ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * FROM personaje WHERE imagen !='' 
		AND (nombre LIKE '%$pal%' or bio LIKE '%$pal%' or fecha_nacimiento LIKE '%$pal%'  or permalink LIKE '%$pal%')
		 LIMIT 50";
	}
