...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Vendors 
</h1>
    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
	$qt = "SELECT * FROM vendor ORDER BY id_vendor DESC LIMIT 500 ";
	
	$pal = $_GET["q"];			
	if($pal!=""){
		$qt = "SELECT * FROM vendor WHERE nombre LIKE '%$pal%' or descripcion LIKE '%$pal%' or permalink LIKE '%$pal%'  or html LIKE '%$pal%' LIMIT 500";
	}
