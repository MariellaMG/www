...
<div class="bloc">
<form id="form1" method="post" enctype="multipart/form-data" action="estado_agregar_form.php">
    ...
    <div class="content">
        ...
        <div class="input medium">
            ...
            <span>Ingresa el nombre del estado</span>
        </div>

		<div class="input medium">

            <label for="input2">Información extra</label>
