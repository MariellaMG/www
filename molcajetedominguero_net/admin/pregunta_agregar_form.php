...
$fotos = "http://appmichoacan.co/uploaded/".$imagen.".jpg";

$qin = "INSERT INTO `appmicho_db`.`pregunta` (`id_pregunta`, `pregunta`, `imagen`, `respuesta`, `opcion1`, `opcion2`, `opcion3`, `opcion4`, `id_region`) VALUES (NULL, '$pregunta', '$imagen', '$respuesta', '$opcion1', '$opcion2', '$opcion3', '$opcion4', '$id_region');";
