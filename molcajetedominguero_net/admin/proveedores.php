...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Personajes 
</h1>
...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM proveedor ORDER BY id_proveedor DESC LIMIT 50 ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * FROM proveedor WHERE proveedor LIKE '%$pal%' or descripcion LIKE '%$pal%' or extra LIKE '%$pal%'  or permalink LIKE '%$pal%' LIMIT 50";
	}
	...
	?>
                  ...
                  <tr id="linea<?php echo $id; ?>">
                    ...
                    <td><?php echo $proveedor; ?></td>
                     <td><a href="/proveedor/<?php echo $permalink; ?>" target="_blank"><?php echo $permalink; ?></a></td>
                   
                    <td><?php echo substr($bio,0,103)."..."; ?></td>
                    
                    
                    <td class="actions">
                    <a href="proveedor_editar.php?id=<?php echo $id; ?>" title="Editar"><img src="img/icons/edit.png" alt="" /></a>
