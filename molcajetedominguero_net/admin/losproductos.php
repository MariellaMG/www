    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
	$qt = "SELECT * FROM losproductos ORDER BY id_producto DESC LIMIT 500 ";
	
	$pal = $_GET["q"];			
	if($pal!=""){
		$qt = "SELECT * FROM losproductos WHERE nombre LIKE '%$pal%' or descripcion LIKE '%$pal%' or permalink LIKE '%$pal%'  or html LIKE '%$pal%' LIMIT 500";
	}
