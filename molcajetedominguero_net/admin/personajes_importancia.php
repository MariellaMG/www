...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM personaje ORDER BY total DESC LIMIT 150 ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * FROM personaje WHERE nombre LIKE '%$pal%' or bio LIKE '%$pal%' or fecha_nacimiento LIKE '%$pal%'  or permalink LIKE '%$pal%' ORDER BY total DESC LIMIT 50";
	}
