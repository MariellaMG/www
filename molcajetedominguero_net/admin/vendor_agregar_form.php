...
$q = "SELECT permalink FROM vendor WHERE permalink LIKE '".$permalink."%'";
...
INSERT INTO `vendor` (`id_vendor`, `nombre`, `imagen`, `fotos`, `archivos`, `descripcion`, `permalink`, `html`, `id_categoria`) VALUES (NULL, '$name', '$imagen', '$fotos', '$fotos', '$descripcion', '$permalink', '$html','$id_categoria');
