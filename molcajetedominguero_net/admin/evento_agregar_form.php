...
$q = "SELECT permalink FROM evento WHERE permalink LIKE '".$permalink."%'";
...
INSERT INTO `evento` (`id_evento`, `nombre`, `imagen`, `fotos`, `archivos`, `descripcion`, `permalink`, `html`, `id_categoria`) VALUES (NULL, '$name', '$imagen', '$fotos', '$fotos', '$descripcion', '$permalink', '$html','$id_categoria');
...
<h1><img src="img/icons/posts.png" alt="" />Agregar evento '<?php echo $name; ?>'</h1>
