...
$q = "SELECT permalink FROM categoria WHERE permalink LIKE '".$permalink."%'";
...
$qin = "INSERT INTO `categoria` (`id_categoria`, `nombre`, `orden`, `extra`, `descripcion`, `permalink`) 
VALUES (NULL, '$nombre', '$orden', '$extra', '$descripcion', '$permalink');";
...
<h1><img src="img/icons/posts.png" alt="" />Categoria agregada '<?php echo $nombre; ?>'</h1>
