...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Peliculas sin Cast (<?php
	$qt = "SELECT count( * ) FROM `contenido` WHERE protagonistas=''";
...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM contenido WHERE protagonistas='' ORDER BY id_contenido DESC LIMIT 50 ";
