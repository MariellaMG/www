...
function Eliminar(t_id){
	...
	if(confirm("Estas seguro que deseas borrar este producto?")){
		$.get("producto_eliminar_get.php?id="+t_id, function(data){
...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Los Vendors 
</h1>
    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
	$qt = "SELECT * FROM losvendor  ";
	
	$pal = $_GET["q"];			
	if($pal!=""){
		$qt = "SELECT * FROM losvendor WHERE nombre LIKE '%$pal%' or descripcion LIKE '%$pal%' or permalink LIKE '%$pal%'  or html LIKE '%$pal%' LIMIT 500";
	}
