...
$q = "SELECT permalink FROM marcas WHERE permalink LIKE '".$permalink."%'";
...
INSERT INTO `marcas` (`id_marcas`, `nombre`, `imagen`, `fotos`, `archivos`, `descripcion`, `permalink`, `html`, `id_categoria`,`id_usuario`) VALUES (NULL, '$name', '$imagen', '$fotos', '$fotos', '$descripcion', '$permalink', '$html','$id_categoria','$id_usuario');
...
<h1><img src="img/icons/posts.png" alt="" />Agregar marca '<?php echo $name; ?>'</h1>
