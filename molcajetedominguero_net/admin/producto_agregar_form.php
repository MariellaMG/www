...
$q = "SELECT permalink FROM producto WHERE permalink LIKE '".$permalink."%'";
...
INSERT INTO `producto` (`id_producto`, `nombre`, `imagen`, `fotos`, `archivos`, `descripcion`, `permalink`, `html`, `id_categoria`) VALUES (NULL, '$name', '$imagen', '$fotos', '$fotos', '$descripcion', '$permalink', '$html','$id_categoria');
