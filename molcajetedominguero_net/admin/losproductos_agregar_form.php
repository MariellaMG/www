...
//$losnegocios = implode(",", $negocios);


$qin = "

INSERT INTO `losproductos` (`id_producto`, `nombre`, `imagen`, `fotos`, `archivos`, `descripcion`, `permalink`, `html`, `id_categoria`,`id_usuario`,`id_marcas`) VALUES (NULL, '$name', '$imagen', '$fotos', '$fotos', '$descripcion', '$permalink', '$html','$id_categoria','$id_usuario','$id_marcas');
...
<h1><img src="img/icons/posts.png" alt="" />Agregar Producto '<?php echo $name; ?>'</h1>
