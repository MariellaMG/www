...
<?php	include "menu.php"; ?>
	...
	$qt = "SELECT count(*) FROM lugar WHERE imagen='' ";
	...
	while ($rowt = mysql_fetch_row($resultt)){
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Lugares  <?php echo $totales; ?>
</h1>
    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
	$qt = "SELECT * FROM lugar WHERE imagen='' AND (html='' OR html='..') ORDER BY id_lugar DESC LIMIT 50 ";
