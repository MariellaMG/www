...
<h1><img src="img/icons/posts.png" alt="" />Editar ciudad: '<?php echo $nombre; ?>'</h1>

	<div class="notif success" id="completo" style="margin-top:20px;">
            <strong>Success: </strong>La ciudad se ha editado correctamente
