...
$q = "SELECT permalink FROM usuario WHERE permalink LIKE '".$permalink."%'";
...
VALUES (
NULL , '$colaborador', '$pass', '$nombre','$imagen',0,'$hotel');";

$fotos = "http://nice-n-easy.co/archivos/".$imagen.".jpg";

$qin = "INSERT INTO `usuario` (`id_usuario`, `nivel`, `usuario`, `pass`, `nombre`, `descripcion`, `imagen`, `fotos`, `archivos`, `fecha_alta`, `fecha_edicion`, `genero`, `permalink`,`id_proyecto`) 
VALUES (NULL, '$nivel', '$usuario', '$pass', '$nombre', '$descripcion', '$imagen', '$fotos', '$archivos', now(), now(), '$genero', '$permalink','$proyecto');";
...
<h1><img src="img/icons/posts.png" alt="" />Usuario agregado '<?php echo $nombre; ?>'</h1>

	<div class="notif success" id="completo" style="margin-top:20px;">
            <strong>Success: </strong>El usuario se ha agregado correctamente
