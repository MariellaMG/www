...
var server="http://molcajetedominguero.info/uploaded/";
...
<div class="bloc">
<form id="form1" method="post" enctype="multipart/form-data" action="losproductos_agregar_form.php">
	...
	?>
        ...
        <div class="input">
          <label for="select">Usuario</label>
            <select name="id_usuario" id="id_marca">
            	<option value="0">Elige uno</option>
    <?php
	$qt = " SELECT * FROM `usuario` ";
	echo $qt;
	$resultt = mysqli_query($link,$qt);
	while ($row = mysqli_fetch_row($resultt)){
		//echo utf8_encode($row[0]);
	...
	?>
         ...
         <div class="input">
          <label for="select">Marca</label>
            <select name="id_marcas" id="id_marcas">
            	<option value="0">Elige uno</option>
    <?php
	$qt = " SELECT * FROM `marcas` ";
	echo $qt;
	$resultt = mysqli_query($link,$qt);
	while ($row = mysqli_fetch_row($resultt)){
		//echo utf8_encode($row[0]);
