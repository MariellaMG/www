...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Peliculas Completas (<?php
	$qt = "SELECT count( * ) FROM `contenido` WHERE protagonistas!='' AND directores!='' AND protagonistas!='' AND escritores!='' AND proveedores!=''";
...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM contenido WHERE protagonistas!='' AND directores!='' AND protagonistas!='' AND escritores!='' ORDER BY id_contenido DESC LIMIT 50 ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * FROM contenido WHERE keywords ='' AND
		 (titulo LIKE '%$pal%' or titulo_original LIKE '%$pal%' or sinopsis LIKE '%$pal%'  or permalink LIKE '%$pal%' )
		  LIMIT 50";
	}
