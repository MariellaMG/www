...
function terminaPDF(t_t,t_file,t_ext){
	$("#pdf").val("http://cushman.pro/uploaded/"+t_file+"."+t_ext);
}
...
<input name="silueta_img" id="silueta_img" type="hidden" value="">
    ...
    <div class="content">
        ...
        <div class="input medium">
            ...
            <input type="text" id="testfit" name="testfit" />
            <span>Test fit</span>
        </div>
        ...
        <div class="input medium">
            ...
            <input type="text" id="video360" name="video360" />
            <span>Test fit</span>
        </div>
	...
	while ($row = mysql_fetch_row($resultt)){
		//echo utf8_encode($row[0]);
		echo '<option value="'.$row[0].'" onClick="Centrar('.$row[2].','.$row[3].')">'.$row[1].'</option>
		';
	}
	?>
            </select>
...
<br /><br />
        ...
        <div class="input medium">
            ...
            <input type="text" id="silueta" name="silueta" disabled />
        </div>
