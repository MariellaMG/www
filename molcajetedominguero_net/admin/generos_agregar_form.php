...
$qin = "
INSERT INTO `genero` (`id_genero`, `genero`, `orden`, `permalink`) VALUES (NULL, '$genero', '$orden', '$permalink');
";
...
<h1><img src="img/icons/posts.png" alt="" />Agregar Genero</h1>

	<div class="notif success" id="completo" style="margin-top:20px;">
            <strong>Success: </strong>El Genero se ha agregado correctamente
