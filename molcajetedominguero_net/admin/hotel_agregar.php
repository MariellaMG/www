...
function initialize() {
  var myLatlng = new google.maps.LatLng(21.15441731575597, -86.84996008872986);
  var myOptions = {
    zoom: 10,
    center: myLatlng,
...
<h1><img src="img/icons/posts.png" alt="" />Agregar paquete </h1>
...
<div class="bloc">
<form id="form1" method="post" enctype="multipart/form-data" action="hotel_agregar_form.php">
