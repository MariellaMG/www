...
var frames_d;
var server = "http://appmichoacan.co/";
...
<h1><img src="img/icons/posts.png" alt="" />Agregar pregunta</h1>
...
<form id="form1" method="post" enctype="multipart/form-data" action="pregunta_agregar_form.php">
...
<input name="video" id="video" type="hidden" value="">
    ...
    <?php
	$qt = "SELECT * FROM region ORDER BY id_region ";
	...
	?>
         ...
         <div class="input medium">
            <label for="input2">Pregunta</label>
            <input type="text" id="pregunta" name="pregunta" />
        </div>
        
        
        <div class="input">
            <label for="select">Respuesta</label>
 		...
 		<div class="input medium">
            <label for="input2">Opcion 1</label>
            <input type="text" id="opcion1" name="opcion1" />
        </div>
        <div class="input medium">
            <label for="input2">Opcion 2</label>
            <input type="text" id="opcion2" name="opcion2" />
        </div>
        <div class="input medium">
            <label for="input2">Opcion 3</label>
            <input type="text" id="opcion3" name="opcion3" />
        </div>
        <div class="input medium">
            <label for="input2">Opcion 4</label>
        ...
        <label for="input2">Foto de la pregunta</label>
