...
$q = "SELECT permalink FROM losvendor WHERE permalink LIKE '".$permalink."%'";
...
INSERT INTO `losvendor` (`id_losvendor`, `nombre`, `imagen`, `fotos`, `archivos`, `descripcion`, `permalink`, `html`, `id_categoria`,`id_usuario`,`id_marcas`) VALUES (NULL, '$name', '$imagen', '$fotos', '$fotos', '$descripcion', '$permalink', '$html','$id_categoria','$id_usuario','$id_marcas');
...
<h1><img src="img/icons/posts.png" alt="" />Agregar Vendor '<?php echo $name; ?>'</h1>
