...
var frames_d;
var server = "http://200.95.239.6/";

function terminaUpload(t_t){
	
	
	frames_d = "<img src='"+server+"uploaded/"+t_t+".jpg'  width='75' height='70' />";
...
<h1><img src="img/icons/posts.png" alt="" />Editar usuario '<?php echo $nombre; ?>'</h1>
...
<form id="form1" method="post" enctype="multipart/form-data" action="usuario_editar_form.php">
...
<input name="id" id="id" type="hidden" value="<?php echo $id; ?>">
    ...
    <div class="content">
         ...
         <div class="input medium">
            ...
            <input type="text" id="colaborador" name="colaborador" value="<?php echo $colaborador; ?>" />
        </div>
        ...
        <label for="input2">Foto del usuario</label>
          ...
          <div id="thumb">
          <img src='/uploaded/<?php echo $imagen; ?>.jpg'  width='75'  />
          </div>
