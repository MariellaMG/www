    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
	$qt = "SELECT * FROM Paquetes ORDER BY id_paquete DESC ";
	
	$pal = $_GET["q"];
	
	if($pal!=""){
		$qt = "SELECT * FROM Paquetes WHERE titulo LIKE '%$pal%' or descripcion LIKE '%$pal%' or permalink LIKE '%$pal%'  ORDER BY id_paquete DESC";
	}
