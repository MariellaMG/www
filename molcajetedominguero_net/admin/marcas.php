...
function Eliminar(t_id){
	...
	if(confirm("Estas seguro que deseas borrar esta marca?")){
		$.get("marcas_eliminar_get.php?id="+t_id, function(data){
...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Marcas 
</h1>
...
<div class="bloc">
	...
	$pal = $_GET["q"];			
	if($pal!=""){
		$qt = "SELECT * FROM marcas WHERE nombre LIKE '%$pal%' or descripcion LIKE '%$pal%' or permalink LIKE '%$pal%'  or html LIKE '%$pal%' LIMIT 500";
	}
