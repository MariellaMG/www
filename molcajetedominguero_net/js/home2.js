...
function VerNoche(){
	...
	$("#logoint").stop();
	var nn = $(window).width()/3;
	$("#logoint").animate({top: -nn+"px"},400);
...
function VerSanFran(){
	//$('#header').css("background-color", "#78B19B");
	$('#header1').css("background-image", "url(/noche/san_fran.png)"); 
	//$('#header').css("background-image", "url(/design2_partes/1/dom_d1_1.jpg)"); 
}
