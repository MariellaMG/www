<?php
$header = "/images_innovation/research/Research_Development_header.jpg";
$img1_w = 800;
$img1_h = 630;
$img1 = "/images_innovation/research/Research_Development_1.jpg";
$img2 = "/images_innovation/research/Research_Development_2.jpg";
$img3 = "/images_innovation/research/Research_Development_3.jpg";
$img4 = "/images_products/products_home/Products_4.jpg";
$title = "RESEARCH & DEVELOPMENT";
$header_t = "RESEARCH &<br />
 DEVELOPMENT";
...
<div id="profile_container_a_int" style="width:8000px; margin-left:-5px;" >
    ...
    <div class="bb1_gray" id="cc1" style="background-color:#8AC16A;"   >
        <div class="box_vw" id="cc2">
        	<h2 class="title_vw" style="font-size:2.0rvw;">
...
Our food scientists have the<br />
 technical training, passion for food<br />
 and development experience needed to<br />
 create, match, optimize or improve the<br />
 functionality of a wide range of products.<br />
<br />

With access to a well-appointed,<br />
11 station R&D lab and the<br />
 manufacturing facility steps away, it’s no<br />
 wonder Haliburton’s product development<br />
 team has earned the reputation for<br />
 extremely fast project turn-around times.
