<?php
$header = "/images_products/artisan_soups/ArtisanSoups_header.jpg";
$img1_w = 800;
$img1_h = 690;
$img1 = "/images_products/artisan_soups/ArtisanSoups_1.jpg";
$img2 = "/images_products/artisan_soups/ArtisanSoups_2.jpg";
$img3 = "/images_products/artisan_soups/ArtisanSoups_3.jpg";
$img4 = "/images_products/artisan_soups/ArtisanSoups_4.jpg";
$title = "ARTISAN SOUPS";
$header_t = "ARTISAN SOUPS";
$txt2="<strong>Carrot Ginger Soup</strong><br />
Vegetable Purée based soup made of carrots,<br/>
ginger, aromatics and spices ";
$txt3="<strong>New England Clam Chowder</strong><br/>
Creamy seafood based soup mixed with clam meat,<br/>
ham, vegetables, herbs and spices ";
$txt4="<strong>White Bean Bisque</strong><br />
Bean Purée based soup made of white beans,<br/>
vegetable stock, aromatics and spices ";
?>
...
<div id="profile_container_a_int" style="width:8000px; margin-left:-5px;" >
    ...
    <div class="bb1_gray" id="cc1" style="background-color: #C7B345 !important;"   >
        <div class="box_vw" id="cc2">
         ...
         With extensive high volume kettle cooking <br/>
          capabilities, scalable pilot lines and licenses from<br/>
           the USDA and FDA, we are well equipped to work on <br/>
            any custom soup project.<br/><br/>


Whether you’re looking for a match to your award<br/>
 winning clam chowder or you need us to start with a<br/>
  clean sheet of paper, we can help you set your soups<br/>
