...
<h1><img src="img/icons/posts.png" alt="" />Agregar Acta</h1>
...
<form id="form1" method="post" enctype="multipart/form-data" action="acta_agregar_form.php">
...
<input name="archivos" id="archivos" type="hidden" value="">
    ...
    <div class="content">
         ...
         <div class="input medium">
            <label for="input2">Referencia (AHMM,FAC,LN.71)</label>
            
            <div style="margin-top:10px;">
            <div style="float:left; font-size:20px; margin-right:6px;">AHMM,FAC</div>
            <div style="float:left; width:80px;"><input type="text" id="num1" name="num1" style="width:80px;" /></div>
            <div style="float:left; font-size:20px; margin-right:6px; margin-left:3px;">,LN.</div>
            <div style="float:left;"><input type="text" id="num2" name="num2" /></div>
        ...
        <div class="input medium">
         ...
         <div class="input medium">
            ...
            <input type="text" id="hojas" name="hojas" />
        </div>
	...
	?>
        ...
        <div class="input medium">
            ...
            <textarea name="asunto" cols="" rows=""></textarea>
        </div>
        
          <div class="input medium">
            <label for="input2">Anexo:</label>
            <textarea name="anexo" cols="" rows=""></textarea>
        </div>
        
          <div class="input medium">
            <label for="input2">Observaciones:</label>
            <textarea name="observaciones" cols="" rows=""></textarea>
        </div>
