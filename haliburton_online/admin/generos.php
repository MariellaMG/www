...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM genero ORDER BY genero LIMIT 50 ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * FROM genero WHERE genero LIKE '%$pal%' or orden LIKE '%$pal%' or permalink LIKE '%$pal%' LIMIT 50";
	}
	...
	?>
                  ...
                  <tr id="linea<?php echo $id; ?>">
                    ...
                    <td><?php echo utf8_encode($genero); ?></td>
                     <td><a href="/noticia/<?php echo $permalink; ?>" target="_blank"><?php echo $permalink; ?></a></td>
