...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Peliculas con proveedor (<?php
	$qt = "SELECT count( * ) FROM `contenido` WHERE proveedores!=''";
...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM contenido WHERE proveedores !='' ORDER BY id_contenido DESC LIMIT 100 ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * FROM contenido WHERE proveedores !='' AND
