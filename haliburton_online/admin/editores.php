...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Editores 
</h1>
...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM editor ORDER BY editor LIMIT 50 ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * FROM editor WHERE editor LIKE '%$pal%' or orden LIKE '%$pal%' or extra LIKE '%$pal%' LIMIT 50";
	}
