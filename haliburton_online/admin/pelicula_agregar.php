...
<input id="directores" name="directores" type="hidden" value=""  />
<input id="escritores" name="escritores" type="hidden" value=""  />
<input id="protagonistas" name="protagonistas" type="hidden" value=""  />
