...
include("includes/mysql_infos.php");
	...
	$qt = "SELECT * FROM evento WHERE id_evento = '$id' ";
...
<h1><img src="img/icons/posts.png" alt="" />Editar evento</h1>
...
<div class="bloc">
<form id="form1" method="post" enctype="multipart/form-data" action="evento_editar_form.php">
...
<input name="id" id="id" type="hidden" value="<?php echo $id; ?>">
    ...
    <div class="content">
         ...
         <div class="input medium">
            ...
            <span>Ingresa el titulo del evento</span>
        </div>
        
        
            <div class="input textarea">
        <label for="textarea1">Previo</label>
            <textarea name="previo" id="previo" rows="6" cols="2" style="width:300px; height:80px;"><?php echo $previo; ?></textarea><br>
            Incluye la descripción breve del evento</div>
       
         	<div class="input">
            <label for="select">Universidad</label>
            
            <select name="universidad" id="universidad" style="width:400px;">
            	<option value="0" >Elige una</option>
    <?php
	$qt = "SELECT * FROM uni WHERE nombre != ''  ORDER BY nombre ";
	$resultt = mysql_query($qt, $db);
	while ($row = mysql_fetch_row($resultt)){
		//echo utf8_encode($row[0]);
		$sel="";
		
		if($universidad==$row[0]){
	...
	?>
        ...
        <label for="textarea1">Descripci&oacute;n</label>
            <textarea name="desc" id="desc" rows="13" cols="4"><?php echo $contenido; ?></textarea>
            Incluye la descripción del evento</div>
<br><br>
        <div class="submit">
