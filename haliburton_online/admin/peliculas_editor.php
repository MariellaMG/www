...
<?php	include "menu.php"; ?>
        ...
        <!--            
              CONTENT 
                        --> 
        <div id="content">
          <h1><img src="img/icons/edit.png" alt="" />Peliculas de <?php $id = $_GET["id"];
	
		$q_c = "SELECT * FROM editor WHERE id_editor='$id' ";
		//echo $q_c;
...
<div class="bloc">
 ...
 <?php
	...
	$qt = "SELECT * FROM contenido WHERE id_editor = '$id' ORDER BY id_contenido DESC LIMIT 100 ";
