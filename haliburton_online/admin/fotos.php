...
function Eliminar(t_id){
	...
	if(confirm("Estas seguro que deseas borrar este recorrido grabado?")){
		$.get("foto_eliminar_get.php?id="+t_id, function(data){
    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
	$qt = "SELECT * FROM paseo ORDER BY id_paseo DESC ";
	
	$pal = $_GET["q"];
				
	
	if($pal!=""){
		$qt = "SELECT * foto WHERE pregunta LIKE '%$pal%' or opcion1 LIKE '%$pal%' or opcion2 LIKE '%$pal%'  or opcion3 LIKE '%$pal%'";
	}
