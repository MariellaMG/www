...
<?php
	...
	$id = $_GET['id'];
	$qt = "SELECT * FROM vacancy_hotel WHERE id_vacancy_hoteles='$id' ";
	...
	//21.15441731575597, -86.84996008872986
	if($latitud==0){
		$latitud=21.15441731575597;
		$longitud=-86.84996008872986;
		$zoom=11;
	}
?>
...
function terminaUpload(t_t){
	...
	frames_d += "<div class='files'><img src='"+server+"uploaded/"+t_t+".jpg'  width='100' id='frame"+cont_foto+"' onclick='Foto("+cont_foto+");'  /></div>";
	if($("#imagen").val()==""){
...
<h1><img src="img/icons/posts.png" alt="" />Editar hotel '<?php echo $titulo; ?>' </h1>
...
<div class="bloc">
<form id="form1" method="post" enctype="multipart/form-data" action="hotel_editar_form.php">
...
<input name="id" id="id" type="hidden" value="<?php echo $id; ?>">
    ...
    <?php
	$qt = "SELECT * FROM vacancy_zona WHERE nombre != '' ORDER BY nombre ";
	$resultt = mysqli_query($link,$qt);
	...
	?>
        ...
        <div class="input medium">
          ...
          <label for="input2">Descripción</label>
            <textarea name="descripcion" id="descripcion" cols="10" rows="10"><?php echo utf8_encode($descripcion); ?></textarea>
