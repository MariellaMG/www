...
$q = "SELECT permalink FROM video WHERE permalink LIKE '".$permalink."%'";
...
$qin = "INSERT INTO `niceneas_db`.`video` (`id_video`, `id_categoria`, `nombre`, `video`, `imagen`, `archivos`, `fotos`, `permalink`) 
VALUES (NULL, '$categoria', '$nombre', '$video', '$imagen', '$archivos', '$fotos', '$permalink');";
