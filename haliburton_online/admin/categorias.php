    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
	$qt = "SELECT * FROM categoria  ";
	
	$pal = $_GET["q"];
	
	if($pal!=""){
		$qt = "SELECT * FROM categoria WHERE nombre LIKE '%$pal%' or descripcion LIKE '%$pal%' or permalink LIKE '%$pal%' or id_categoria='$pal' ORDER BY categoria";
	}
