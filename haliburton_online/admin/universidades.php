...
<div class="bloc">
	...
	?>
                  ...
                  <tr id="linea<?php echo $id; ?>">
                    ...
                    <td><a href="universidad_editar.php?id=<?php echo $id; ?>"><?php echo $permalink; ?></a></td>
                    
                    <td class="actions">
                    <a href="universidad_editar.php?id=<?php echo $id; ?>" title="Editar"><img src="img/icons/edit.png" alt="" /></a>
