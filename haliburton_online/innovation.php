<?php
$header = "/images_innovation/innovation_home/Innovation_header.jpg";
$img1_w = 800;
$img1_h = 700;
$img1 = "/images_innovation/innovation_home/Innovation_1.jpg";
$img2 = "/images_innovation/innovation_home/Innovation_2.jpg";
$img3 = "/images_innovation/innovation_home/Innovation_3.jpg";
...
<div class="header" id="header" style=" background-image:url(<?php echo $header; ?>);" onclick="HideMenu();">
	<div class="white" id="white" style="width:38vw; height:14.5vw; top:37%;">
    	<div class="white_int" style="padding-top:6%; padding-bottom:12%;">
    		<h1 style=" font-size:3.0vw; padding-top: 2.5vw; "><?php echo $header_t; ?> </h1>
			<h2 style="font-size:1.3vw;">Passion-driven creative food design</h2>
    	</div>
    </div>
</div>
...
<div id="profile_container_a_int" style="width:8000px; margin-left:-5px;" >
    ...
    <div class="bb1_gray" id="cc1" style="background-color:#bcb9db;"   >
        <div class="box_vw" id="cc2">
        	<h2 class="title_vw" style="font-size:2vw;">
            
INNOVATION

</h2>
            <p class="text_vw" style="font-size:1.9vw;">

        As leaders in product design and menu<br />
concept development, Haliburton employs<br />
very passionate chefs and food<br />
scientists. With extensive backgrounds in<br />
restaurant operations, formal training in<br />
culinary arts and food science with years<br />
of experience in food manufacturing,<br />
team members know what it takes to go<br />
