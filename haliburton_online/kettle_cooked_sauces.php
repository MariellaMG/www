<?php
$header = "/images_products/kettle_cooked_sauces/SavorySauces_header.jpg";
$img1_w = 800;
$img1_h = 535;
$img1 = "/images_products/kettle_cooked_sauces/SavorySauces_1_1.jpg";
$img2 = "/images_products/kettle_cooked_sauces/SavorySauces_2.jpg";
$img3 = "/images_products/kettle_cooked_sauces/SavorySauces_3.jpg";
$img4 = "/images_products/kettle_cooked_sauces/SavorySauces_4.jpg";
$title = "KETTLE COOKED SAUCES";
$header_t = "KETTLE COOKED <br /> SAUCES";
$txt2="<strong>Chorizo Hash and Harissa Breakfast Flatbreads</strong><br />
Fire-Roasted Harissa Sauce";
$txt3="<strong>Wok-Fried Ramen Seafood Bowl</strong><br />
Southeast Asian Chile Garlic Sauce";
$txt4="<strong>Buffalo Cauliflower</strong><br />
...
<div id="profile_container_a_int" style="width:8000px; margin-left:-5px;" >
    ...
    <div class="bb1_gray" id="cc1" style="background-color: #6D984A !important;"   >
        <div class="box_vw" id="cc2" style="padding-top:3vw;">
        	<h2 class="title_vw">
...
KETTLE COOKED SAUCES
           ...
           With well over 300 million pounds of kettle<br/>
            capacity, Haliburton has the sauce processing<br/>
             capability to manufacture just about any<br/>
              cooked sauce you or our team can dream up.<br/>
               From traditional mother sauce derivatives to<br/>
                more contemporary fruit and vegetable puree<br/>
              based sauces to ethnic inspired sauces,<br/>
               our development team has the talent and<br/>
                expertise to innovate something new or<br>
