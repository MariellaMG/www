<?php
$header = "/images_products/products_home/Products_header.jpg";
$img1_w = 800;
$img1_h = 700;
$img1 = "/images_products/products_home/Products_1.jpg";
$img2 = "/images_products/products_home/Products_2.jpg";
$img3 = "/images_products/products_home/Products_3.jpg";
$img4 = "/images_products/products_home/Products_4.jpg";
$title = "Products";
$header_t = "PRODUCTS";

$txt2="<strong>Smoky Bloody Mary</strong><br />
Smoked California Chile Bloody Mary Mix, Spicy Pickles,<br/>
and Fire-Roasted Shishito Pepper";


$txt3="<strong>Ahi and Kampachi Poke Bowl</strong><br />
Citrus Miso Vinaigrette, Fire-Roasted Mukimame, <br/>
Pickled Soya Onions, and Wasabi Avocado Crema";

$txt4="<strong>Sous Vide Duck Breast</strong><br />
Fire-Roasted Asparagus, Red Bell Peppers and Onions,<br/>
and Vadouvan Carrot Purée";
...
<div class="header" id="header" style=" background-image:url(<?php echo $header; ?>);" onclick="HideMenu();">
	<div class="white" id="white" style="width:38vw; height:14.5vw;">
    	<div class="white_int" style="padding-bottom: 14%;">
			...
			<h2 style="font-size:1.3vw;">Blending culinary, food science and technology </h2>
    	</div>
    </div>
</div>
...
<div id="profile_container_a_int" style="width:8000px; margin-left:-5px;" >
    ...
    <div class="bb1_gray" id="cc1"   >
        <div class="box_vw" id="cc2">
        	<h2 class="title_vw">CUSTOM FOOD<br />
SERVICE PRODUCTS</h2>
            <p class="text_vw" style="font-size:1.5vw;">

            Haliburton’s custom culinary creations are<br />
designed to meet the flavor needs of multi-unit<br />
restaurant operators looking for scratch-quality,<br />
ready-to-eat convenience and flexible<br />
concept-specific packaging.<br />
<br />
