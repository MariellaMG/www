<?php
$header = "/images_products/iqf_ancient_grains/AncientGrains_header.jpg";
$img1_w = 800;
$img1_h = 700;
$img1 = "/images_products/iqf_ancient_grains/AncientGrains_1.jpg";
$img2 = "/images_products/iqf_ancient_grains/AncientGrains_2.jpg";
$img3 = "/images_products/iqf_ancient_grains/AncientGrains_3.jpg";
$img4 = "/images_products/iqf_ancient_grains/AncientGrains_4.jpg";
$title= "IQF ANCIENT GRAINS";
$header_t = "IQF ANCIENT GRAINS";
$txt2="<strong>Red Wine Demi Grilled Filet</strong><br />
Ancient Grain Risotto mixed with<br/>
Fire-Roasted Portobellini Mushrooms ";
$txt3="<strong>Pistachio Crusted Lamb Rack</strong><br />
Israeli Cous Cous ";
$txt4="<strong>Scallops and Quinoa</strong> <br />
 IQF Quinoa Blend";
?>
...
<div id="profile_container_a_int" style="width:8000px; margin-left:-5px;" >
    ...
    <div class="bb1_gray" id="cc1"  style="background-color: #F1AF64 !important; "  >
        <div class="box_vw" id="cc2" style="padding-top:10vw !important;">
           ...
           Looking for a turnkey thaw and serve <br/>
            grain salad blend or hot grain-based <br/>
             side? Our high capacity blending <br/>
              operation allows us to combine a near <br/>
               limitless number of inclusions such as <br/>
                dried fruits, roasted vegetables, seeds<br/>
                 and even sauces to deliver consistent<br/>
...
<?php
include "products_galery_ancient.php";
?>
