<?php
$header = "/images_products/condiments_dips_and_spreads/Condiments_DipsSpreads_header.jpg";
$img1_w = 800;
$img1_h = 580;
$img1 = "/images_products/condiments_dips_and_spreads/Condiments_DipsSpreads_1.jpg";
$img2 = "/images_products/condiments_dips_and_spreads/Condiments_DipsSpreads_2.jpg";
$img3 = "/images_products/condiments_dips_and_spreads/Condiments_DipsSpreads_3.jpg";
$img4 = "/images_products/condiments_dips_and_spreads/Condiments_DipsSpreads_4.jpg";
$title = "CONDIMENTS, DIPS & SPREADS";
$header_t = "CONDIMENTS, <br />
DIPS & SPREADS";
$txt2="<strong>Edamame Hummus</strong> ";
$txt3="<strong>Reuben Sandwich</strong><br />
Russian Dressing ";
$txt4="<strong>Jalapeño Poppers</strong><br />
Cilantro Lime Aioli";
?>
...
<div id="profile_container_a_int" style="width:8000px; margin-left:-5px;" >
    ...
    <div class="bb1_gray" id="cc1" style="background-color: #C46A7A !important; "   >
        <div class="box_vw" id="cc2" style="padding-top:1.9vw;">
        	<h2 class="title_vw">
...
DIPS AND SPREADS
          ...
          With extensive hot and cold process <br/>
           capabilities our R&D and culinary <br/>
            product development teams can create <br/>
             or match just about any dip or spread <br/>
              you can imagine. From authentic <br/>
               aiolis to cremas, hummus, vegetable <br/>
                or cheese dips, mostardas, relishes, <br/>
                 chutneys and compotes the variety <br/>
                 of condiments, dips and spreads<br/>
                  available are nearly limitless.<br/>
